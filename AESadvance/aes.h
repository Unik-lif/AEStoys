...
static uint8_t exp_key[Nb * (Nr + 1)][MaxLen];
static uint8_t sel_key[MaxStr]; 
static uint8_t key[MaxStr];
static uint8_t in[MaxStr];
static uint8_t temp[MaxStr];
...
static uint8_t RC_Store[12] = {
	0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x11, 0x22, 0x44
	};

/* Reference for quicker Multiply:              *
 * Just find the number here to get the answer. */
